...
;// line 1, lostAndFoundList.html
// line 6, lostAndFoundList.html
// line 7, lostAndFoundList.html
		p("<div class=\"navbar-inner\">\n" + 
"</div>\n" + 
"<div class=\"container\">\n" + 
"	<!-- 左菜单 -->\n" + 
"	");// line 11, lostAndFoundList.html
		new leftMenusTag(lostAndFoundList.this).render(); // line 16, lostAndFoundList.html// line 16, lostAndFoundList.html
		p("    	<!-- 主内容 -->\n" + 
"		  <div class=\"content\" id=\"content\">\n" + 
"            <!-- 标题 -->\n" + 
"            <h3 class=\"title add-commodity-title\">闪购商品列表</h3>\n" + 
"			");// line 16, lostAndFoundList.html
		p("            <!-- table -->\n" + 
"            <table class=\"table\">\n" + 
"                <tr>\n" + 
"                    <th>活动名称</th>\n" + 
...
"                </tr>\n" + 
"                ");// line 24, lostAndFoundList.html
		if(!announcementList.isEmpty()){// line 33, lostAndFoundList.html
                for(Announcements announcements :announcementList){// line 34, lostAndFoundList.html
		p("                	<tr>\n" + 
"                    <td>");// line 34, lostAndFoundList.html
		p(announcements.title);// line 36, lostAndFoundList.html
		p("</td>\n" + 
"                    <td>");// line 36, lostAndFoundList.html
		p(announcements.startTime);// line 37, lostAndFoundList.html
		p("</td>\n" + 
"                    <td>");// line 37, lostAndFoundList.html
		p(announcements.endTime);// line 38, lostAndFoundList.html
		p("</td>\n" + 
"                    <td>\n" + 
"                    	<a id=\"preview\" href=\"");// line 38, lostAndFoundList.html
		p(lookup("AdminController.preview", announcements.id));// line 40, lostAndFoundList.html
		p("\" class=\"defaultBtn btn-sm btn-green\">预览</a>\n" + 
"                        <a id=\"del\" href=\"");// line 40, lostAndFoundList.html
		p(lookup("AdminController.deleteFastGood", announcements.id));// line 41, lostAndFoundList.html
		p("\" class=\"defaultBtn btn-sm btn-red\">删除</a>\n" + 
"                    </td>\n" + 
"                </tr>\n" + 
"                ");// line 41, lostAndFoundList.html
		}// line 44, lostAndFoundList.html
                }// line 45, lostAndFoundList.html
		p("            </table>\n" + 
"            ");// line 45, lostAndFoundList.html
		new pagination(lostAndFoundList.this).render(getUrl(),"page",currentPage,totalPage,null); // line 47, lostAndFoundList.html// line 47, lostAndFoundList.html
            // line 48, lostAndFoundList.html
		p("            <!-- h20 -->\n" + 
"            <div class=\"h20\"></div>\n" + 
"		</div>\n" + 
"\n" + 
"    </div>\n" + 
"</body>\n" + 
"</html>");// line 50, lostAndFoundList.html
...
"</script>\n");// line 7, lostAndFoundList.html
	...
	@Override protected void title() {
		// line 6, lostAndFoundList.html
		p("后台管理-闪购商品列表");// line 6, lostAndFoundList.html
		;
	}
...
// line 48, lostAndFoundList.html
		p("            	");// line 48, lostAndFoundList.html
		p(lookup("AdminController.flashPurchaseList", new Object[]{}));// line 49, lostAndFoundList.html
		p("            ");// line 49, lostAndFoundList.html
