...
import japidviews._tags.headTag;
import models.*;
...
public abstract class backStageLayout extends cn.bran.play.JapidTemplateBase {
	...
	final play.mvc.Scope.RenderArgs renderArgs = play.mvc.Scope.RenderArgs
			.current();
	final play.mvc.Scope.Params params = play.mvc.Scope.Params.current();
	final play.data.validation.Validation validation = play.data.validation.Validation
			.current();
	...
	public backStageLayout(
			cn.bran.japid.template.JapidTemplateBaseWithoutPlay caller) {
		super(caller);
	}
	...
	public void layout() {
		...
		title();
		p("</title>\n" + "	<link type=\"text/css\" href=\"");// line 6,
																// backStageLayout.html
		p(lookupStatic("/public/backStage/css/main.css"));// line 7,
															// backStageLayout.html
		p("\" rel=\"stylesheet\" />\n" + "	<link type=\"text/css\" href=\"");// line
																				// 7,
																				// backStageLayout.html
		p(lookupStatic("/public/backStage/css/default.css"));// line 8,
																// backStageLayout.html
		p("\" rel=\"stylesheet\" />\n" + "	<link href=\"");// line 8,
															// backStageLayout.html
		...
		p("\" rel=\"stylesheet\">\n" + "	<link href=\"");// line 9,
															// backStageLayout.html
		p(lookupStatic("/public/css/default.css"));// line 10,
													// backStageLayout.html
		...
		new headTag(backStageLayout.this).render(); // line 14,
													// backStageLayout.html//
													// line 14,
													// backStageLayout.html
		doLayout();// line 15, backStageLayout.html
		p("<script src=\"");// line 15, backStageLayout.html
		p(lookupStatic("/public/backStage/js/jquery-1.9.1.min.js"));// line 16,
																	// backStageLayout.html
		p("\"></script>\n" + "<script src=\"");// line 16, backStageLayout.html
		p(lookupStatic("/public/frontEnd/js/quo-2.3.6.min.js"));// line 17,
																// backStageLayout.html
		p("\"></script>\n" + "<script type=\"text/javascript\" src=\"");// line
																		// 17,
																		// backStageLayout.html
		...
		p("\" data-cfg-autoload=\"true\"></script>\n" + "<script src=\"");// line
																			// 18,
																			// backStageLayout.html
		p(lookupStatic("/public/backStage/js/default.js"));// line 19,
															// backStageLayout.html
		p("\"></script>\n" + "<script src=\"");// line 19, backStageLayout.html
		p(lookupStatic("/public/js/main/zebra_datepicker.js"));// line 20,
																// backStageLayout.html
		p("\"></script>\n" + "<script src=\"");// line 20, backStageLayout.html
		p(lookupStatic("/public/js/main/core.js"));// line 21,
													// backStageLayout.html
		p("\"></script>\n" + "<script src=\"");// line 21, backStageLayout.html
		p(lookupStatic("/public/js/back_editgood.js"));// line 22,
														// backStageLayout.html
		...
		p(lookupStatic("/public/js/back_fastbuy.js"));// line 24,
														// backStageLayout.html
