...
function uploadSuccess(file, serverData) {
    try {
        ...
        var img_url = serverData.html.trim();
        //console.log(img_url)
//        document.getElementById("packshows_img_url").value = img_url;
//        document.getElementById("image_show_box").innerHTML = '<img src="' + img_url + '" width="300" />';
        $("#image_show_box").append('<img src="'+ img_url + '" width="200" /><input type="hidden" name="img_urlList" value="'+img_url+'"id="packshows_img_url"/>');
    } catch (ex) {
        this.debug(ex);
    }
}
